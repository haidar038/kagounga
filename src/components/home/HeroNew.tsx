  ...
  return (
    ...
    >
      ...
      <div
        ...
        role="img"
        aria-label="Traditional popeda preparation in Papua"
      >
      ...
      <div className="container-page relative z-10 py-20 text-center">
        <div className="mx-auto max-w-3xl animate-fade-in">
          ...
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-card/20 backdrop-blur-sm px-4 py-1.5 text-sm font-medium text-white/90 border border-white/20">
            <span>🌴</span>
            <span>Authentic Papua Flavor</span>
          </div>
          ...
          >
            ...
            <span className="relative inline-block">
              <span className="relative z-10 text-primary">Papua</span>
          ...
          <p className="mt-6 text-lg leading-relaxed text-white/80 sm:text-xl">
            Kagōunga brings authentic popeda to your table. Traditional sago goodness,
            made simple for modern life.
          </p>
