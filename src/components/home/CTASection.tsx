    ...
    <section className="py-16 sm:py-20">
      <div className="container-page">
        <div className="rounded-3xl bg-accent p-8 lg:p-16 text-center">
          <h2 className="font-heading text-3xl font-bold text-accent-foreground sm:text-4xl lg:text-5xl">
            {cta.headline}
          </h2>
          {cta.description && (
          ...
          {cta.button_url && (
            <Button
              asChild
              size="xl"
              className="mt-8 bg-white text-accent hover:bg-white/90 font-semibold"
            >
