        ...
        <div className="min-h-[60vh] bg-background">
          <div className="container-page py-16 text-center">
            <div className="mx-auto max-w-md">
              ...
              <h1 className="font-heading text-2xl font-bold">Keranjang Kosong</h1>
    ...
    <Layout>
      <div className="min-h-screen bg-background py-8 sm:py-12">
        <div className="container-page">
          <h1 className="font-heading text-3xl font-bold sm:text-4xl">Keranjang Belanja</h1>
          <p className="mt-2 text-muted">{totalItems} item dalam keranjang</p>
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-3">
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          <Link
                            ...
                            className="font-heading text-lg font-semibold transition-colors hover:text-accent"
                          >
                            {item.product.name}
                          </Link>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 rounded-2xl border border-border bg-card p-6">
                <h2 className="font-heading text-xl font-semibold">Ringkasan Pesanan</h2>
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-primary-foreground">
                      {totalPrice >= 150000 ? "Gratis" : formatPrice(15000)}
                    </span>
                  </div>
                  {totalPrice < 150000 && (
                    <p className="text-xs text-muted">
                      Belanja {formatPrice(150000 - totalPrice)} lagi untuk gratis ongkir!
                    </p>
                  )}
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-heading text-2xl font-bold">
                    {formatPrice(totalPrice + (totalPrice >= 150000 ? 0 : 15000))}
                  </span>
                </div>
