            ...
            <div className="min-h-[70vh] bg-background">
                <div className="container-page py-16 text-center">
                    <div className="mx-auto max-w-md">
                        ...
                        <p className="mt-3 text-muted">Terima kasih telah berbelanja di Kagōunga. Konfirmasi pesanan telah dikirim ke email Anda.</p>
                        ...
                        <div className="mt-6 rounded-2xl border border-accent/20 bg-accent/5 p-6 text-left">
                            <h3 className="font-heading font-semibold flex items-center gap-2">📦 Lacak Pesanan Anda</h3>
                            <p className="mt-2 text-sm text-muted">Cek status pesanan Anda kapan saja dengan nomor pesanan yang dikirim ke email.</p>
