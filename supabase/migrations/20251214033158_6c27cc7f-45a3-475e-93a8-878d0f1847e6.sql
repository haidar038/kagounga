...
INSERT INTO public.news_posts (slug, title, excerpt, body, featured_image, is_published, published_at) VALUES
  ('popeda-festival-2024', 'Kagōunga Hadir di Festival Kuliner Papua 2024', 'Kami dengan bangga mengumumkan partisipasi kami dalam Festival Kuliner Papua 2024.', 'Kagōunga akan hadir di Festival Kuliner Papua 2024 yang akan diselenggarakan di Jayapura pada tanggal 15-17 Agustus 2024. Kami akan membawa berbagai varian popeda instan terbaru dan mengadakan demo memasak setiap harinya. Jangan lewatkan kesempatan untuk mencicipi popeda autentik dan bertemu langsung dengan tim kami!', 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800', true, now() - interval '2 days'),
  ...
  ('sustainability-initiative', 'Komitmen Kami untuk Keberlanjutan', 'Langkah-langkah yang kami ambil untuk mendukung petani sagu lokal.', 'Kagōunga berkomitmen untuk mendukung keberlanjutan lingkungan dan kesejahteraan petani sagu lokal. Kami bekerja sama langsung dengan petani di Maluku dan Papua untuk memastikan praktik pertanian yang berkelanjutan. Program ini tidak hanya menjaga kualitas sagu kami tetapi juga membantu meningkatkan taraf hidup masyarakat lokal.', 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800', true, now() - interval '10 days');